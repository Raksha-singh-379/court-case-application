...
import com.courtcase.myapp.repository.UserDataRepository;
import com.courtcase.myapp.service.UserDataService;
...
/**
 * REST controller for managing {@link com.courtcase.myapp.domain.UserData}.
 */
@RestController
@RequestMapping("/api")
