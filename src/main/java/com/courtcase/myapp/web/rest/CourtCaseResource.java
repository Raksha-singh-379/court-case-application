...
import com.courtcase.myapp.repository.CourtCaseRepository;
import com.courtcase.myapp.service.CourtCaseService;
...
/**
 * REST controller for managing {@link com.courtcase.myapp.domain.CourtCase}.
 */
@RestController
@RequestMapping("/api")
