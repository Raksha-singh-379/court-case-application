...
import com.courtcase.myapp.repository.HearingRepository;
import com.courtcase.myapp.service.HearingService;
...
/**
 * REST controller for managing {@link com.courtcase.myapp.domain.Hearing}.
 */
@RestController
@RequestMapping("/api")
